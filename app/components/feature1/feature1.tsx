    ...
    <>
      ...
      >
        <div className="w-[90%] flex max-[73.75em]:flex-col">
          ...
          <FeatureComp2
            list={featureList1}
            className="flex-1 flex pl-[50px] pr-[50px] gap-[80px] py-[50px] bg-[#0D0D0D] border-[1px] border-solid  rounded-[30px] border-[#2171C04D] flex-wrap max-[80em]:pr-[20px] max-[80em]:pl-[30px] max-[80em]:gap-[30px] max-[80em]:py-[35px]"
