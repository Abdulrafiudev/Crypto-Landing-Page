    ...
    <>
      <div className="w-full flex justify-center h-auto mt-[150px]">
        <div className="w-[90%] flex max-[38em]:flex-col">
          ...
          <FeatureComp2
            list={featureList1}
            className="flex-1 flex pl-[130px] pr-[100px] gap-[80px] py-[50px] bg-[#0D0D0D] border-[1px] border-solid  rounded-[30px] border-[#2171C04D] flex-wrap max-[38em]:pr-[20px] max-[38em]:pl-[20px] max-[38em]:gap-[20px]"
            padding="pl-[130px] max-[38em]:pl-0"
