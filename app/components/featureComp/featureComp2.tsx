...
const FeatureComp2: React.FC<{
  ...
  return (
    <>
      <div className="flex flex-col gap-[50px] max-[73.75em]:mt-[20px] max-[73.75em]:gap-[20px]">
        <div className={clsx("flex flex-col flex-1", padding)}>
          ...
          <p className="text-[#FFFFFFB2] text-[16px] font-[400] mt-[20px] max-w-[500px] max-[73.75em]:max-w-full max-[38em]:max-w-[500px]">
            {description}
          </p>
        </div>
        {secondFeature && (
          <ArrowBtn className="bg-[#1A60A61A] px-[20px] py-[8px] text-[#FFFFFF] rounded-[4px] flex gap-[10px] w-[180px] justify-between ml-[50px] max-[73.75em]:ml-0 ">
            Get Started
          </ArrowBtn>
        )}
